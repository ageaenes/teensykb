...
int BEGINROWPIN = 19;
int ENDROWPIN = 24;
int BEGINCOLUMNPIN = 0;
int ENDCOLUMNPIN = 18;

int keyMap[NUMROWS][NUMCOLUMNS] = {
...
int functionLayer[NUMROWS][NUMCOLUMNS] = {
...
int lastDebounceTime[NUMROWS][NUMCOLUMNS] = {
...
int lastButtonState[NUMROWS][NUMCOLUMNS] = {
...
int buttonState[NUMROWS][NUMCOLUMNS] = {
  {HIGH, HIGH, HIGH, HIGH, HIGH, HIGH, HIGH, HIGH, HIGH, HIGH, HIGH, HIGH, HIGH, HIGH, HIGH, HIGH, HIGH, HIGH, HIGH, HIGH},
  {HIGH, HIGH, HIGH, HIGH, HIGH, HIGH, HIGH, HIGH, HIGH, HIGH, HIGH, HIGH, HIGH, HIGH, HIGH, HIGH, HIGH, HIGH, HIGH, HIGH},
  {HIGH, HIGH, HIGH, HIGH, HIGH, HIGH, HIGH, HIGH, HIGH, HIGH, HIGH, HIGH, HIGH, HIGH, HIGH, HIGH, HIGH, HIGH, HIGH, HIGH},
  {HIGH, HIGH, HIGH, HIGH, HIGH, HIGH, HIGH, HIGH, HIGH, HIGH, HIGH, HIGH, HIGH, HIGH, HIGH, HIGH, HIGH, HIGH, HIGH, HIGH},
...
void loop() {
  ...
  for (int i = BEGINROWPIN; i < ENDROWPIN; i++) {
    digitalWriteFast(i, LOW);
    delay(1);
    for (int ii = BEGINCOLUMNPIN; ii <= ENDCOLUMNPIN; ii++) {
